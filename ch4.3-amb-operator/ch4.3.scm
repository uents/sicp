...
;;; ambオペレータのambは特殊形式ではなく手続きなので、
;;; an-element-ofはapplyを使って以下のようにも実装できる
#|
(define (an-element-of items)
  (apply amb items))
|#
...
(define (a-pythagorean-triple-ex)
  (let* ((k (an-integer-starting-from 1))
...
#|
(a-pythagorean-triple-between-ex 1 20)
;;=> '(3 4 5)
(try-again)
...
(parse '(the student in the cat sleeps))
;;=>  '(sentence
;;      (noun-phrase
