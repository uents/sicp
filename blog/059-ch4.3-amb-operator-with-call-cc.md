...
そこで、ambオペレータをcall/ccを使って実装する。On Lispのコードを少し改変しただけですが。。
...
- https://github.com/uents/sicp/blob/master/amb.scm
- https://github.com/uents/sicp/blob/master/ch4.3.scm
